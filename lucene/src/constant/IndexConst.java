...
public class IndexConst {
	...
	public static final String RANK_SUBDOMAIN_PUBLICATIONCOUNT_FIELD = "publicationCount";
    public static final String RANK_SUBDOMAIN_CITATIONCOUNT_FIELD = "citationCount";
}